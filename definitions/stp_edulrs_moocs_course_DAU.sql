CREATE OR REPLACE PROCEDURE `jchuang-project.ding_test.stp_edulrs_moocs_course_DAU`(target_table STRING, start_date STRING, end_date STRING)
BEGIN
    ...
    CREATE OR REPLACE TEMP TABLE base_data AS (
        SELECT
            ...
            END AS duration_sec
        FROM `dw_storage.edulrs_course_moocs` AS R
        WHERE
