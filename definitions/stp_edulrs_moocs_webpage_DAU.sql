CREATE OR REPLACE PROCEDURE `jchuang-project.ding_test.stp_edulrs_moocs_webpage_DAU`(target_table STRING, start_date STRING, end_date STRING)
BEGIN
    ...
    CREATE OR REPLACE TEMP TABLE base_data AS (
        SELECT
            ...
            verb_name,
            CASE
                WHEN R.result_duration >= 14400 THEN 14400
                ELSE R.result_duration
            END AS duration_sec
        FROM `dw_storage.edulrs_webpage_moocs` AS R
        WHERE
